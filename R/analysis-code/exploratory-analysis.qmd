...
data_location <- here::here("data","raw-data","processeddata.rds")

#load data
# Loading the needed datasets
madaproject <- read_excel("data_patrick.xlsx")

tst <- suppressWarnings(read_csv("TST_Placement.csv", show_col_types = FALSE))
```
